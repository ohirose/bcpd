...
CASES = {
    "face-1": ("face-g-x.txt", "face-g-y.txt", "face-g-triangles.txt",
               "-w0 -b0.7 -l100 -g.1 -J300 -K200 -p -ux -c1e-6 -n500 -r1 "
               "-sY -ux -Ggeodesic,0.9,{faces}"),
    "face-2": ("face-g-y.txt", "face-g-x.txt", "face-g-triangles.txt",
               "-w0 -b0.7 -l100 -g.1 -J300 -K200 -p -ux -c1e-6 -n500 -r1 "
               "-sY -ux -Ggeodesic,0.9,{faces}"),
    "female-1": ("female-x.txt", "female-y.txt", "female-triangles.txt",
                 "-w0 -b0.7 -l100 -g3 -J300 -K200 -p -ux -c1e-6 -n500 -r1 "
                 "-sY -ux -Ggeodesic,0.2,{faces}"),
    ...
    "male-2": ("male-y.txt", "male-x.txt", "male-triangles.txt",
               "-w0 -b1.3 -l500 -g3 -J300 -K300 -p -ux -c1e-6 -n500 -r1 "
               "-sY -ux -Ggeodesic,0.5,{faces}"),
}
...
if __name__ == "__main__":
    ...
    execute(x, y, options, trajectory=True, faces=faces)
